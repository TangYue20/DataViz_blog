...
1. The color used for differentiate 'Net Importers' and 'Net Exporters' are not distinct, which cannot makes readers quickly clarify two different groups with different relationship of import and export values.
