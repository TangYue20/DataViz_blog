...
![](image/2.transform data.png){width=50%}
...
![](image/5.load data.png){width=90%}
...
![](image/18.drag raws and column.png){width=90%}
...
![](image/19.2 edit country filter.png){width=90%}
...
![](image/19.3 click 9 countries.png){width=90%}
...
![](image/21. add one more trading volume.png){width=90%}
